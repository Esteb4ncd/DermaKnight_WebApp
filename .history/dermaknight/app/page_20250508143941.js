...
const ingredients = [
  ...
  }, 
  {
      ...
      description: "Antioxidant that evens out skin tone, boosts collagen production, and fades hyper pigmentation.",
  }, 
  {
      name: "Ceramides:",
      image: "/ingredients/image_1.png",
...
export default function Home() {
  return (
    <div className={styles.auth_container}>
      <header className={styles.text_h1}>
        <h1>Recommended Ingredients</h1>
      </header>
