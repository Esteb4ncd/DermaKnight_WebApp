...
export default function QuizStartPage() {
    return (
        <div className='auth-container'>
            ...
            <div>
                <p className={styles.startText}>Find the best ingredients for your skin<br> </br> It will be a series of questions regarding your skin’s health and skincare habits.</p>
