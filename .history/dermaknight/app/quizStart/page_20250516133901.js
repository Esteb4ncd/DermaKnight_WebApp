...
export default function QuizStartPage() {
    return (
        <div className='auth-container'>
            ...
            <div>
                <p className={styles.textLineOnje}>Find the best ingredients for your skin It will be a series of questions regarding your skin’s health and skincare habits.</p>
