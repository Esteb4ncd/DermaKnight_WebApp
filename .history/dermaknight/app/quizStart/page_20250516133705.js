...
export default function QuizStartPage() {
    return (
        <div className='auth-container'>
            ...
            <div>
                <p className={sartText.styles}>Find the best ingredients for your skin /n It will be a series of questions regarding your skin’s health and skincare habits.</p>
