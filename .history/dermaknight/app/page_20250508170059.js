  ...
  return (
    <div className={styles.authContainer}>
      ...
      <main>
        ...
        <p>Uneven skin tone means parts of your face may look darker, redder, or more dull than others. This can show up as patches, redness, or shadowy areas and is common in all skin types.</p>
        </section>
