...
return (
    ...
    {open && (
        <div className="dropdown-content">
            ...
            <strong style={{ "text-align": "left"}}>It plays a role in:</strong>
            <ul style={{ "text-align": "left"}}>
            ...
            <strong style={{ "text-align": "left"}}>What it is:</strong>
            <ul style={{ "text-align": "left"}}>
            ...
            <strong style={{ "text-align": "left"}}>Why Niacinamide Is Used:</strong>
            <ul style={{ "text-align": "left"}}>
