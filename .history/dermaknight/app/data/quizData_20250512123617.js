export const quizQuestions = [
  ...
  },
  {
    ...
    options: [
      { id: 'a', text: "Combination\n Oily in the T-Zone (forehead, nose) and normal or dry everywhere else" },
      { id: 'b', text: "Dry\n Skin feels tight and dry all-year round and flaking or itching is common" },
      { id: 'c', text: "Normal\n Mild oiliness, dryness or breakouts can appear occasionally" },
      { id: 'd', text: "Oily\n Excess oil all over the face, often causing blocked pores" }
    ],
    correctAnswer: null
  },
  {
